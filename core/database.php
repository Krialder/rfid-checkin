 ...
 * 
 * Provides secure PDO-based database connectivity with error handling,
 * query optimization, and transaction management using singleton pattern.
 * 
 ...
 * 
 * Establishes and maintains a single database connection with health monitoring
 ...
 * 
 * Central query execution function with proper error handling,
 * parameter binding, and debug logging. Supports both SELECT
...
function executeQuery($sql, $params = []) {
    ...
    try {
        // Use the shared database utilities for consistency
        $result = $sharedDatabase->executeOptimizedQuery($sql, $params);
        
        // Create a mock PDOStatement-like object for backward compatibility
        ...
        logMessage('ERROR', 'Legacy executeQuery failed, using SharedUtilities', [
            'sql' => $sql,
            'params' => $params,
            'error' => $e->getMessage()
        ]);
